...
new InetSocketAddress("www.csdn.com",80);//http://www.csdn.net
System.out.println("hostName:"+socketAddress.getHostName()+"\naddress:"+(socketAddress.isUnresolved()?"unresolved":"resolved"));
if(!socketAddress.isUnresolved())
{
	System.out.println("addr:"+socketAddress.getAddress());
}
